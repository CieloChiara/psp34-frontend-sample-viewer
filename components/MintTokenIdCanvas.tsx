...
//      await contract.tx['psp34Mintable::mint']({gasLimit}, actingAddress, { u64: tokenId });
      await contract.tx['Shiden34Contract::mint']({gasLimit}, actingAddress, { u64: tokenId });
  ...
  const setup = async () => {
    ...
    //if (!blockchainUrl && !newDataset[0]?.url) {
    if (!blockchainUrl) {
        return;
    }
  ...
  return (
    <div className="text-center">
      ...
      <div className="text-center p-2 mt-5 m-auto max-w-6xl w-11/12 border-[#323943] bg-[#121923] border border-1 rounded">
        <div className="mb-3 text-xl">Connect Wallet</div>
        <button
      ...
      <div className="text-center p-2 mt-5 m-auto max-w-6xl w-11/12 border-[#323943] bg-[#121923] border border-1 rounded">
        <div className="mb-3 text-xl">Mint NFT</div>
